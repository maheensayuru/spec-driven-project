import { z } from 'zod';
import { ObligationResponseSchema, RiskLevelSchema } from './obligations.contract.js';
...
export const DashboardMetricsResponseSchema = z.object({
  ...
  imminentNoticeDeadlinesCount: z.number().int(),
  imminentRenewalsCount: z.number().int(),
