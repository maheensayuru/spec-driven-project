...
const EnvSchema = z.object({
  ...
  SESSION_SECRET: z.string().min(32).default('renewalradar_super_secure_session_secret_32_bytes_min'),
  DATABASE_URL: z.string().default('postgresql://renewalradar:local_dev_password@localhost:5432/renewalradar_dev'),
